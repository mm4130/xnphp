...
{
	if (file_exists($GLOBALS['-XN-']['dirNameDir'] . 'xndata.xnj')) $xnj = new XNJsonFile($GLOBALS['-XN-']['dirNameDir'] . 'xndata.xnj');
...

{
	...
	function __construct($bot, $chat = null, $level = null)
	{
		$this->bot = $bot;
		$this->chat = $chat;
		$this->level = $level;
	...
	function __wakeup($chat = null, $level = null)
	{
		if ($chat && $level) {
			$this->chat = $chat;
			$this->level = $level;
	...
	function media($type, $media, $args = [])
	{
	...
	function mediamsg($type, $media, $caption, $args = [])
	{
	...
	function mediabtn($type, $media, $markup, $args = [])
	{
	...
	function mediamsgbtn($type, $media, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $markup;
		$this->bot->sendMedia($this->chat, $type, $media, $args, $this->level);
	...
	function videonote($videonote, $args = [])
	{
	...
	function document($document, $args = [])
	{
	...
	function photomsg($photo, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendPhoto($this->chat, $photo, $args, $$this->level);
		return $this;
	...
	function voicemsg($voice, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendVoice($this->chat, $voice, $args, $this->level);
		return $this;
	...
	function videomsg($video, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendVideo($this->chat, $video, $args, $this->level);
		return $this;
	...
	function audiomsg($audio, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendAudio($this->chat, $audio, $args, $this->level);
		return $this;
	...
	function videonotemsg($videonote, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendVideoNote($this->chat, $videonote, $args, $this->level);
		return $this;
	...
	function stickermsg($sticker, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendSticker($this->chat, $sticker, $args, $this->level);
		return $this;
	...
	function documentmsg($document, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendDocument($this->chat, $document, $args, $this->level);
		return $this;
	...
	function filemsg($file, $caption, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendFile($this->chat, $file, $args, $this->level);
		return $this;
	...
	function photobtn($photo, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$this->bot->sendPhoto($this->chat, $photo, $args, $$this->level);
		return $this;
	...
	function voicebtn($voice, $markup, $args = [])
	{
	...
	function videobtn($video, $markup, $args = [])
	{
		$args['reply_markup'] = $caption;
		$this->bot->sendVideo($this->chat, $video, $args, $this->level);
		return $this;
	...
	function audiobtn($audio, $markup, $args = [])
	{
		$args['reply_markup'] = $caption;
		$this->bot->sendAudio($this->chat, $audio, $args, $this->level);
		return $this;
	...
	function videonotebtn($videonote, $markup, $args = [])
	{
		$args['reply_markup'] = $caption;
		$this->bot->sendVideoNote($this->chat, $videonote, $args, $this->level);
		return $this;
	...
	function stickerbtn($sticker, $markup, $args = [])
	{
		$args['reply_markup'] = $caption;
		$this->bot->sendSticker($this->chat, $sticker, $args, $this->level);
		return $this;
	...
	function documentbtn($document, $markup, $args = [])
	{
		$args['reply_markup'] = $caption;
		$this->bot->sendDocument($this->chat, $document, $args, $this->level);
		return $this;
	...
	function filebtn($file, $markup, $args = [])
	{
		$args['reply_markup'] = $markup;
		$this->bot->sendFile($this->chat, $file, $args, $this->level);
		return $this;
	...
	function photomsgbtn($photo, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendPhoto($this->chat, $photo, $args, $$this->level);
	...
	function voicemsgbtn($voice, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendVoice($this->chat, $voice, $args, $this->level);
	...
	function videomsgbtn($video, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendVideo($this->chat, $video, $args, $this->level);
	...
	function audiomsgbtn($audio, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendAudio($this->chat, $audio, $args, $this->level);
	...
	function videonotemsgbtn($videonote, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendVideoNote($this->chat, $videonote, $args, $this->level);
	...
	function stickermsgbtn($sticker, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendSticker($this->chat, $sticker, $args, $this->level);
	...
	function documentmsgbtn($document, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendDocument($this->chat, $document, $args, $this->level);
	...
	function filemsgbtn($file, $caption, $markup, $args = [])
	{
		$args['caption'] = $caption;
		$args['reply_markup'] = $caption;
		$this->bot->sendFile($this->chat, $file, $args, $this->level);
...

{
	...
	function send($chat = null, $level = null)
	{
	...
	function getProfile($user, $level = 3)
	{
		$args['user_id'] = $user;
	...
	function sendFile($chat, $file, $args = [], $level = 3)
	{
	...
	function unfilterUpdates($filter = [], $func = false)
	{
		if (!in_array($this->updateType() , $filter)) {
			if ($func) $func($this->data);
			exit();
...

{
	...
	function getFileType($file)
	{
		...
		return [0 => "thumb", 2 => "image", 5 => "document", 3 => "voice", 10 => "document", 4 => "video", 9 => "audio", 13 => "video_note", 8 => "sticker"][ord($file[0]) ];
	}
