...
$tokens=json_decode(xndata("faketoken/random"),true);
...
return json_decode(xndata("fromattomimetype"),true)[$format];
}function mimetype_to_format($mimetype){
return json_decode(xndata("formattomimetype"),true)[$mimetype];
}
// Time-------------------------------------
...
return json_decode(xndata("hashalgos/length"),true)[$algo];
}
// Calc-------------------------------------
class XNProCalc {
// consts variables
